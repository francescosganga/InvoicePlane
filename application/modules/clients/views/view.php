                            ...
                            <table class="table no-margin">
                                ...
                                <?php if ($client->client_phone) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="tel:<?php _htmlsc($client->client_phone); ?>"><?php _htmlsc($client->client_phone); ?></a>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                                <?php if ($client->client_mobile) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="tel:<?php _htmlsc($client->client_mobile); ?>"><?php _htmlsc($client->client_mobile); ?></a><br />
                                            <a style="font-size: 16px;" target="_blank" href="https://api.whatsapp.com/send?phone=39<?php _htmlsc($client->client_mobile); ?>"><img style="width: 18px; height: 18px;" src="<?php echo base_url(); ?>assets/core/img/whatsapp-icon.png">WHATSAPP</a>
                                        </td>
                                    </tr>
                                <?php endif; ?>
